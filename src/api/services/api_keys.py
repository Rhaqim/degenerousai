...
async def create_api_key(request: APIKeyCreateRequest):
    ...
    try:
        ...
        return JSONResponse(
            content={"api_key": request.api_key, "message": "API key created successfully"},
            status_code=201,
        )
...
async def read_api_key(user_id: UUID):
    ...
    try:
        ...
        if api_key:
            return JSONResponse(
                content={"api_key": api_key, "message": "API key retrieved successfully"},
                status_code=200,
            )
        else:
...
async def update_api_key(request: APIKeyCreateRequest):
    """
...
async def list_api_keys():
    ...
    try:
        ...
        return JSONResponse(
            content={"api_keys": api_keys, "message": "API keys retrieved successfully"},
            status_code=200,
        )
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
